...
import com.ximalaya.business.payable.authorization.query.thrift.api.dto.ThriftUserPaidAlbumViewDto;
...
@NoArgsConstructor
@AllArgsConstructor
public class PackInfo extends QueryParam {
    ...
    private List<ThriftUserPaidAlbumViewDto> userPaidAlbumViewDto;
}
