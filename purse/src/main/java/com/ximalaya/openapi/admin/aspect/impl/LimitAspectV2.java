...
import com.ximalaya.omp.openapi.payment.aspect.annotation.LimitAopV2;
...
public class LimitAspectV2{
    ...
    //    @Around("@annotation(com.ximalaya.omp.openapi.payment.aspect.annotation.LimitAopV2) && args(limitAopV2)")
    @Around("@annotation(limitAopV2)")
    public Object limitAspect(ProceedingJoinPoint pjp,LimitAopV2 limitAopV2) throws Throwable{
        ...
        if (limitAccessResult == GLOBAL_RATE_LIMIT_EXCEED){
            // 全局错误
